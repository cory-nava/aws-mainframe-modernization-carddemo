//HERC01A JOB (ACCT),'UPLOAD CSD',CLASS=A,MSGCLASS=A,NOTIFY=HERC01
//STEP1    EXEC PGM=IEBGENER
//SYSPRINT DD SYSOUT=*
//SYSUT2   DD DSN=HERC01.CARDDEMO.CSD,DISP=(NEW,CATLG,DELETE),
...
//SYSUT1   DD *
 ...
 DEFINE PROGRAM(COUSR01C) GROUP(CARDDEMO)
        ...
        USELPACOPY(NO) STATUS(ENABLED) CEDF(YES) DATALOCATION(ANY)
        EXECKEY(USER) CONCURRENCY(QUASIRENT) API(CICSAPI) DYNAMIC(NO)
        EXECUTIONSET(FULLAPI) JVM(NO) DEFINETIME(22/05/02 20:12:09)
        CHANGETIME(22/05/02 20:12:09) CHANGEUSRID(AWSUSER)
        CHANGEAGENT(CSDAPI) CHANGEAGREL(0730)
 DEFINE PROGRAM(COUSR02C) GROUP(CARDDEMO)
        LANGUAGE(COBOL) RELOAD(NO) RESIDENT(NO) USAGE(NORMAL)
        USELPACOPY(NO) STATUS(ENABLED) CEDF(YES) DATALOCATION(ANY)
        EXECKEY(USER) CONCURRENCY(QUASIRENT) API(CICSAPI) DYNAMIC(NO)
        EXECUTIONSET(FULLAPI) JVM(NO) DEFINETIME(22/05/03 19:39:42)
        CHANGETIME(22/05/03 19:39:42) CHANGEUSRID(AWSUSER)
        CHANGEAGENT(CSDAPI) CHANGEAGREL(0730)
 DEFINE PROGRAM(COUSR03C) GROUP(CARDDEMO)
        LANGUAGE(COBOL) RELOAD(NO) RESIDENT(NO) USAGE(NORMAL)
        USELPACOPY(NO) STATUS(ENABLED) CEDF(YES) DATALOCATION(ANY)
        EXECKEY(USER) CONCURRENCY(QUASIRENT) API(CICSAPI) DYNAMIC(NO)
        EXECUTIONSET(FULLAPI) JVM(NO) DEFINETIME(22/06/09 20:39:05)
        CHANGETIME(22/06/09 20:39:05) CHANGEUSRID(AWSUSER)
        CHANGEAGENT(CSDAPI) CHANGEAGREL(0730)
